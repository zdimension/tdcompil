 ...
 * Last file update:  3-Dec-2021 10:04 (eg)
 */
...
%token KFOREACH KIN
%token KSTATIC KCONST

%token TINT TFLOAT TBOOL TSTRING TVOID


%type   <ast>   declarations declaration
%type   <ast>   stmt expr var_decl type var call var_decl_inner
...
stmt:           ';'                     { $$ = make_expr_statement(NULL); }
        ...
        |       KFOREACH type var KIN '[' eparam_list ']' stmt
                                        { $$ = make_foreach_statement($2,$3,$6,$8);}
        ...
        |       var_decl ';'            { $$ = $1;}
        |       KSTATIC var_decl ';'    { $$ = $2; set_var_decl_static($2); }
        |       prototype ';'           { $$ = $1;}
        |       error ';'               { yyerrok; $$ = NULL; }
        ;
...
expr:
        ...
        |       var                   { $$ = $1; }
        |       expr '[' expr ']'     { $$ = make_string_access($1, 0, $3, NULL); }
        |       expr '[' expr_opt ':' expr_opt ']'
                                      { $$ = make_string_access($1, 1, $3, $5); }
        |       call                  { $$ = $1; }
