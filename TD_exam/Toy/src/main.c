 ...
 * Last file update:  6-Dec-2021 19:42 (eg)
 */
...
bool trace_mode   = false; ///< Add trace to functions 
extern FILE *yyin;         ///< input stream used by flex (yyin is declared by flex)

extern int yyparse(); // For MacOs
