...
enum node_kind {k_constant, k_identifier, k_type, k_var_decl, k_expression,
                ...
                k_return_statement, k_break_statement, k_switch_statement, k_try_statement, k_throw_statement};
...
//
// ======================================================================
enum expr_kind {assign, augassign, uarith, barith, ulogic, blogic, comp, ternary, parenthesis,
                preincr, postincr};
